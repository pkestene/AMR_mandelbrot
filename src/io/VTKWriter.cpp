...
// =======================================================
// =======================================================
void VTKWriter::write_metadata(int iStep,
			       double time)
{
				...
				const std::vector<double>& cell_data)
{
   ...
   * write cell data.
   */
  m_out_file << "    <DataArray type=\"" << dataType
	     << "\" Name=\"" << dataname
...
// ================================================================
// ================================================================
void VTKWriter::write_appended_binary_cell_data(const std::string& dataname,
						const std::vector<double>& cell_data)
{
...
// ================================================================
// ================================================================
int VTKWriter::write_base64_binary_data(const char* numeric_data, size_t byte_length)
{
